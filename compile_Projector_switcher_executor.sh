...
cp -f $windows_project_dir/include/user_main.h $linux_project_dir/include
cp -f $windows_project_dir/utils.c $linux_project_dir/user
cp -f $windows_project_dir/include/utils.h $linux_project_dir/include
cp -f $windows_project_dir/include/device_settings.h $linux_project_dir/include
cp -f $windows_project_dir/include/global_printf_usage.h $linux_project_dir/include
